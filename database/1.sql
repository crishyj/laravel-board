...
-- Dumping structure for table board.failed_jobs
...
-- Dumping data for table board.failed_jobs: ~0 rows (approximately)
DELETE FROM `failed_jobs`;
/*!40000 ALTER TABLE `failed_jobs` DISABLE KEYS */;
/*!40000 ALTER TABLE `failed_jobs` ENABLE KEYS */;


-- Dumping structure for table board.inits
...
-- Dumping data for table board.inits: ~3 rows (approximately)
DELETE FROM `inits`;
...
-- Dumping structure for table board.migrations
...
-- Dumping structure for table board.password_resets
...
-- Dumping data for table board.password_resets: ~0 rows (approximately)
DELETE FROM `password_resets`;
/*!40000 ALTER TABLE `password_resets` DISABLE KEYS */;
/*!40000 ALTER TABLE `password_resets` ENABLE KEYS */;


-- Dumping structure for table board.statuses
...
-- Dumping data for table board.statuses: ~0 rows (approximately)
...
-- Dumping data for table board.users: ~0 rows (approximately)
DELETE FROM `users`;
